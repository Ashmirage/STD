...
u8 TP_Init(void)
{
	...
	if(lcddev.id == 0X5510 || lcddev.id == 0X9806 || lcddev.id == 0X4342 || lcddev.id == 0X4384 || lcddev.id == 0X1018 )				//4.3寸电容触摸屏
	{
		...
		tp_dev.touchtype|=0X80;	//电容屏 
		return 0;
	}else if(lcddev.id==0X1963 || lcddev.id == 0X7084 || lcddev.id == 0X7016)			//7寸电容触摸屏
	{
